...
Player.create(username: 'jason')
Player.create(username: 'andrew')
Player.create(username: 'anna')
Player.create(username: 'iman')
Player.create(username: 'jenny')
Player.create(username: 'joseph')
Player.create(username: 'marissa')
Player.create(username: 'mike')
Player.create(username: 'ana')
Player.create(username: 'beth')
Player.create(username: 'nathan')
Player.create(username: 'robin')
Player.create(username: 'ab')
Player.create(username: 'nick')
Player.create(username: 'lane')
Player.create(username: 'hillary')
Player.create(username: 'ann')
